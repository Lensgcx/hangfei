...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    if ($_POST['media_type'] == '0')
    {
        ...
        {
            $ad_code = basename($image->upload_image($_FILES['ad_img'], '../mobile/data/afficheimg'));
        }
...
elseif ($_REQUEST['act'] == 'show_image')
{
    ...
    else
    {
        ...
        {
			//echo 3;die;
            $img_url = '../data/afficheimg/' . $_GET['img_url'];
        }
    }
	//echo $img_url;die;
