...
.picScroll2 .bd1 li:nth-child(odd){border-right:0.1em solid gainsboro;border-bottom:0.1em solid gainsboro;}
.picScroll2 .bd1 li:nth-child(even){border-bottom:0.1em solid gainsboro;}
...
?>
                ...
                <?php endif; ?>
                <br><?php echo sub_str(htmlspecialchars($this->_var['goods']['goods_name']),8); ?>
                </li>
