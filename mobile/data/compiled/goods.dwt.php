...
<link href="<?php echo $this->_var['ectouch_themes']; ?>/ectouch.css?id=11" rel="stylesheet" type="text/css" />
...
<section class="goodsInfo">
    ...
    <ul>
    <li>
	<div  style="overflow: hidden;background: #fb6a87;position: relative; height: 2.5rem; overflow: hidden;">
...
<?php if ($this->_var['userid']): ?>
	...
	<?php else: ?>
	 <a href="http://mp.weixin.qq.com/s?__biz=MzA3NjAwMTE4Ng==&mid=201612026&idx=1&sn=e9f5cc7eec62af571ed8094a858e9d84#rd"><button type="button" class="guanzhu" style="padding: 1 rem 1.5 rem;">马上关注</button></a>
	<?php endif; ?>
 </div>
