<div class="f_l email">
  ...
  <div class="batch_title"><p><?php echo $this->_var['lang']['email_subscribe']; ?></p></div>
  <div class="batch_txt">
  <p>输入邮箱号</p>
  <div class="blank"></div>
  <div class="batch_input">
    ...
    <input type="button" class="bnt_blue"  value="<?php echo $this->_var['lang']['email_list_cancel']; ?>" onclick="cancel_email_list();" />
  </div>
